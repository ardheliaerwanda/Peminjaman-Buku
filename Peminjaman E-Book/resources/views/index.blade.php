...
<body>
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg  navbar-light shadow-sm  py-3 py-lg-0" style="background: #BCD4FF; height:100px;"> 
        <a href="/index/{lang}" class="navbar-brand p-0" style="text-align: center">
        ...
        <button type="button" class="btn text-dark" style="float:right;"><a href="/signup/{lang}" class="btn btn-warning btn-md">Sign Up</a></button>
            <button type="button" class="btn text-dark " style="float:right;"><a href="/login/{lang}" class="btn btn-warning btn-md ">Log In</a></button>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid py-5 ">
        <div class="container"> <center>
                    <h4 style="margin-top:180px;">{{__('index.welcome')}}</h4>
                    <h4 style="z-index: 1;">{{__('index.here')}}</h4>
                    <img src="{{asset('admin/assets/img/foto.png')}}" style ="z-index: -1; margin-top: -300px" height="500px" width="500px;">
            </center>
        </div>
    </div>
    <!-- Endmain -->
    ...
    <!-- Footer Start -->
    <div class="container-fluid text-light py-4" style="background: #BCD4FF; position:absolute; height:60px;">
        <div class="container">
            <div class="row g-0">
