...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-light shadow-sm px-5 py-3 py-lg-0" style="background: #BCD4FF; height:100px;"> 
        ...
        <button type="button" class="btn text-dark" style="float:right;"><a href="/signup/{lang}" class="btn btn-warning btn-md">{{__('logout.signup')}}</a></button>
            <button type="button" class="btn text-dark " style="float:right;"><a href="/login/{lang}" class="btn btn-warning btn-md ">{{__('logout.login')}}</a></button>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid py-5 ">
        <div class="container"> <center>
                    <h4 style="margin-top:220px;">{{__('logout.success')}}</h4>
