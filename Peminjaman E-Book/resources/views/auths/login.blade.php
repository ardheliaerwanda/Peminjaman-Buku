            ...
            <div class="row ">
                <div class="col">
                    <div class="section-title"><center>
                        <h5 class="text-dark">{{__('login.log-in')}}</h5><br></center>
                    </div>
                    <form class="form-auth-small" action="/postlogin" method="POST"><center>
                            {{csrf_field()}}
                            <div class="form-group row" style="left:50%; right:50%;">
                                    <label for="inputemail" class="col-sm-2 col-form-label">{{__('login.email')}}<span class="required">:</span></label>
                                    <div class="col-sm">
                            ...
                            <div class="form-group row">
                                    <label for="inputpassword" class="col-sm-2 col-form-label">{{__('login.password')}}<span class="required">:</span></label>
                                    <div class="col-sm">
                                ...
                                <br><br>
								<button type="submit" class="btn btn-primary" style="float:center;">{{__('login.submit')}}</button>
                                <br>
								<center><a href="/signup/{lang}" ><u>{{__('login.dont')}}</u></a></center>
							</form></center>
                </div>
            </div>
        </div>
