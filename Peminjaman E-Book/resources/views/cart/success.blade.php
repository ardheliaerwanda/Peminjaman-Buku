...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-light shadow-sm px-5 py-3 py-lg-0" style="background: #BCD4FF; height:100px;"> 
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse" >
            ...
            <button type="button" class="btn text-dark " style="float:right;"><a href="/logout" class="btn btn-warning btn-md ">{{__('success.logout')}}</a></button>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid py-5 " >
        <div class="container"> <center>
                    <p style="margin-top: 30vh; font-size: 40px; text-align:center;" class="text-center">{{__('success.success')}}</p>
                    <a href="/home/{lang}"> {{__('success.click')}}</a>
